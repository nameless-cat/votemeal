  ...
  public static final ModelMatcher<VoteHistory> VOTE_MATCHER = ModelMatcher.of(VoteHistory.class,
      (expected, actual) -> expected == actual ||
          (Objects.equals(expected.getDate(), actual.getDate())
              ...
              && Objects.equals(expected.getRestaurant().getAddress().getStreet(),
              actual.getRestaurant().getAddress().getStreet())
              && Objects.equals(expected.getRestaurant().getAddress().getBuilding(),
              actual.getRestaurant().getAddress().getBuilding()))
  );
